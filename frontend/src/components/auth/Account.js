...
export default function Account(props) {
    ...
    try{
        const res = await axios.post(`${process.env.REACT_APP_API_BASE_URL}/api/auth/logout`,{},config);
    ...
    return (
        ...
        <div className="container" style={{marginTop:'4rem',justifyContent:'center',alignContent:'center',alignItems:'center'}}>
            ...
            <div className="row">
                <div className="col-xl-12 col-lg-6 col-md-12 col-sm-12" style={{marginTop:'3rem'}}>
                <center>
