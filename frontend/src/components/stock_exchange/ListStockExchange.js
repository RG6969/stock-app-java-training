...
export default function ListStockExchange() {
    ...
    <div class="col-sm-6 text-center"><p>Loading ...</p>
        ...
        <div>
            ...
            <div className="container" style={{marginTop:'5rem'}}>
                <div className="row">
                    <div className="col">
                        <Link className="btn" to="/manage/stockexchange/add" style={{backgroundColor:'#5a5af3',color:'white'}}><i className="fa fa-upload">{'  '}Add Stock Exchange</i></Link>
                    </div>
                                ...
                                <div className="card-header">
                                    <div className="row">
                                        ...
                                        <div className="col-xl-3" style={{float:'right'}}>
                                            ...
                                            <Link to={`/manage/stockexchange/edit/${stockExchange.id}`} className="btn btn-warning" style={{marginLeft:'1rem',float:'right'}}><i className="fa fa-pencil"  ></i> Edit</Link>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <Link to={`/manage/companies/stockExchange/${stockExchange.id}`} class="btn" style={{backgroundColor:'#5a5af3',color:'white'}}>Companies</Link>
                                    </div>
