...
export default function StockCompanies(props) {
    ...
    useEffect(()=>{
        axios.get(`${process.env.REACT_APP_API_BASE_URL}/api/companies/stockExchange/${id}`,config).then((res)=>{
            console.log(res);
            axios.get(`${process.env.REACT_APP_API_BASE_URL}/api/stockExchange/${id}`,config).then((result)=>{
                console.log(result)
                setSe(result.data)
        ...
        <div>
            ...
            <div className="container" style={{marginTop:'5rem'}}>
                ...
                <div className="row" style={{marginTop:'2rem'}}>
                    ...
                    <center><h5>Stock Exchange - {se.name}</h5></center>
                    </div>
                </div>
                <div className="row">
                    {
